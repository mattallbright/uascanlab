...
#Rotation Regressor
echo "~~~Extract absolute rotation average (mm) and euclidian distance~~~"
...
echo "~~~Extract absolute displacement average (mm) and euclidian distance~~~"
